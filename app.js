...
const projects = [
    ...
    },
    {
        ...
        description: "針對量販通路的單色簡約印刷包裝設計，控制製版成本之餘，仍維持版面視覺的均衡美感與資訊可讀性。"
    },
    {
        title: "馬桶水溶清潔塊彩盒版",
        category: "packaging",
    ...
    },
    {
        ...
        description: "展示使用前後對比、安全檢測報告與使用方法說明，以清晰的格狀版面呈現，在手機裝置上也容易閱讀。"
    },
    {
        title: "進口純棉浴巾",
        category: "promo",
    ...
    },
    {
        ...
        description: "實木轉角書桌之情境文宣，著重書桌於現代居家角落的空間利用，以溫暖的光影合成攝影照吸引受眾。"
    },
    {
        title: "工學舒適記憶枕",
        category: "promo",
    ...
    },
    {
        ...
        description: "主打免膠、免釘、一扣即合的快速安裝，影片以素人第一人稱視角切入，強調 DIY 的輕鬆感。"
    },
    {
        title: "可微波耐熱玻璃餐盒",
        category: "video",
